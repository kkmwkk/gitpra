...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
	...
	<div class="review-detail-wrap">
		<form name="reviewupdateForm" role="form" method="post" action="/market/reviewUpdate">
			<input type="hidden" id="prdReviewno" name="prdReviewno" value="${reivewdetail.prdReviewno}"/>
			<table>
				<tbody>
					<tr>
						<td>
					...
					<tr>
						<td>
							<textarea name="prdReviewcontent" class="form-control" id="message-text"
		            				style="height:10em; width:40em; resize:none;" >${reivewdetail.prdReviewcontent}</textarea>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<div class="reviewDetail_btn">
				...
				<a href="/market/reviewDelete?prdReviewno=${reivewdetail.prdReviewno}" 
